...
def test_correctness():
    for alg_name in f5oqs_sdk.get_enabled_sig_mechanisms():
...
def check_correctness(alg_name):
    with f5oqs_sdk.Signature(alg_name) as sig:
...
def test_not_supported():
    try:
        with f5oqs_sdk.Signature("bogus") as sig:
...
def test_not_enabled():
    ...
    for alg_name in f5oqs_sdk.get_supported_sig_mechanisms():
        if alg_name not in f5oqs_sdk.get_enabled_sig_mechanisms():
